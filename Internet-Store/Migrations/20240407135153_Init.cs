    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModelWithSizes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ModelWithSizes_Models_ModelId",
                        column: x => x.ModelId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reactions_Models_ModelId",
                        column: x => x.ModelId,
                        principalTable: "Models",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ModelWithSizeId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Items_ModelWithSizes_ModelWithSizeId",
                        column: x => x.ModelWithSizeId,
                        principalTable: "ModelWithSizes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Items_ModelWithSizeId",
                table: "Items",
                column: "ModelWithSizeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModelWithSizes_ModelId",
                table: "ModelWithSizes",
                column: "ModelId");
